...
def execute_command():
    ...
    Look out for any grammatical errors in the raw command and assume the correct word. If you don't understand the language send it over to the translate module.
